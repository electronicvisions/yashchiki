...
# check if it can be specialized
spack_packages=(
    "visionary-defaults^python@2.7.15 %gcc@7.2.0"
    "visionary-defaults+gccxml^python@2.7.15 %gcc@7.2.0"
    "visionary-analysis~dev^python@2.7.15 %gcc@7.2.0"
    "visionary-analysis^python@2.7.15 %gcc@7.2.0"
    "visionary-dev-tools^python@2.7.15 %gcc@7.2.0"
    "visionary-dls~dev^python@2.7.15 %gcc@7.2.0"
    "visionary-dls^python@2.7.15 %gcc@7.2.0"
    "visionary-dls~dev+gccxml^python@2.7.15 %gcc@7.2.0"
    "visionary-dls+gccxml^python@2.7.15 %gcc@7.2.0"
    "visionary-nux~dev^python@2.7.15 %gcc@7.2.0"
    "visionary-nux^python@2.7.15 %gcc@7.2.0"
    "visionary-spikey~dev^python@2.7.15 %gcc@7.2.0"
    "visionary-spikey^python@2.7.15 %gcc@7.2.0"
    "visionary-wafer~dev^python@2.7.15 %gcc@7.2.0"
    "visionary-wafer^python@2.7.15 %gcc@7.2.0"
    "visionary-wafer~dev+gccxml^python@2.7.15 %gcc@7.2.0"
    "visionary-wafer+gccxml^python@2.7.15 %gcc@7.2.0"
    "visionary-dls-demos^python@2.7.15 %gcc@7.2.0"
)
# tensorflow fails
install_from_buildcache
